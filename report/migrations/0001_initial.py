    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, help_text='a description of the report', verbose_name='Description')),
                ('category', models.TextField(blank=True, choices=[('assignment', 'Assignment'), ('exam', 'Exam'), ('requirement', 'Requirement')])),
                ...
                ('exam_paper', models.BooleanField(default=False, help_text='If yes, the result of each attempt by a user will be stored. Necessary for marking.', verbose_name='Record Paper')),
                ...
                ('draft', models.BooleanField(blank=True, default=False, help_text='If yes, the report is not displayed in the report list and can only be taken by users who can edit reports.', verbose_name='Draft')),
        ...
        migrations.AddField(
            model_name='question',
            name='report',
            field=models.ManyToManyField(blank=True, to='report.Report', verbose_name='Report'),
        ),
        migrations.CreateModel(
            name='Progress',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='report.MCQuestion', verbose_name='Question')),
            ],
            options={
                'verbose_name': 'Choice',
